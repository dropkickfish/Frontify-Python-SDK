...
All examples will follow the usage of the async client, but a synchronous client can be generated by setting

```toml
async_client = false
```

in the pyproject.toml file and regenerating. 

The default and this setting were used to create asyncFrontifyClient and syncFrontifyClient in this codebase.
